...
export default function AdminProgramsPage() {
  ...
  useEffect(() => {
    ...
    const filtered = programs.filter(program =>
      ...
      (program.description && program.description.toLowerCase().includes(lowercasedFilter))
    );
    ...
    <div className="container mx-auto">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage collections of courses that can be sold to customers.</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
              ...
              <TableBody>
                {filteredPrograms.map((program) => (
                  <TableRow key={program.id}>
                    ...
                    <TableCell>
                        {program.isStandardSubscription ? (program.standardSubscriptionPrice || 'N/A') : (program.price || 'N/A')}
                    </TableCell>
