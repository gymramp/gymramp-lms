        ...
        <div className="flex-1 mt-4 space-y-3">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="space-y-2">
              ...
              {i % 2 === 0 && <div className="pl-4 space-y-1"><Skeleton className="h-6 w-5/6" /><Skeleton className="h-6 w-4/6" /></div>}
            </div>
          ))}
        </div>
        <div className="p-2 border-t"><Skeleton className="h-12 w-full" /></div>
      </aside>
    );
  }
