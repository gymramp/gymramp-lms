          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 py-4">
            ...
            <FormField control={form.control} name="companyId" render={({ field }) => (
              <FormItem> <FormLabel>Brand</FormLabel>
                ...
                >
                  <FormControl>
                    <div> {/* Wrap SelectTrigger in a div */}
                ...
                <FormControl> 
                  <div> {/* Wrap ScrollArea in a div */}
                    <ScrollArea className="h-40 w-full rounded-md border p-4">
                        ...
                        ) : ( <div className="text-sm text-muted-foreground italic flex items-center justify-center h-full"> {selectedCompanyIdForm ? 'No locations for this brand or your access.' : 'Select brand first.'} </div> )}
                    </ScrollArea>
                  </div>
